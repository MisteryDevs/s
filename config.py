...
UPSTREAM_REPO = getenv(
    "UPSTREAM_REPO",
    "https://github.com/MisteryDevs/s",
)
...
SUPPORT_CHANNEL = getenv("SUPPORT_CHANNEL", "https://t.me/BOTPAYOUTNEXU")
SUPPORT_GROUP = getenv("SUPPORT_GROUP", "https://t.me/gOdxnexuchat")
